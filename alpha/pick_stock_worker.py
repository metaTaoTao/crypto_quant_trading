...
from .pick_base import PickStockWorkBase
from ..MarketBu.Market import all_symbol
from ..PickStockBu.PickStockBase import PickStockBase
...
class PickStockWorker(PickStockWorkBase):
    ...
    def fit(self):
        ...
        def _first_batch_fit():
            ...
            with MulPidProgress(len(self.first_stock_pickers), 'pick first_choice stocks complete') as progress:
