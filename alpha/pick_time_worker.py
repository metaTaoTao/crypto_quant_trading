...
from ..FactorBuyBu.FactorBuyBase import FactorBuyBase
from ..FactorSellBu.FactorSellBase import FactorSellBase
from .pick_base import PickTimeWorkBase
...
class PickTimeWorker(PickTimeWorkBase):
    ...
    def __init__(self, cap, kl_pd, benchmark, buy_factors, sell_factors):
        ...
        self.combine_kl_pd = SymbolPd.combine_pre_kl_pd(self.kl_pd, n_folds=1)
