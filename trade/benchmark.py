...
from core.base import PickleStateMixin


class Benchmark(PickleStateMixin):
    """基准类，混入PickleStateMixin，因为在.store__result_tuple会进行对象本地序列化"""
    ...
    def __init__(self, benchmark=None, start=None, end=None, n_folds=2, rs=True, benchmark_kl_pd=None):
        ...
        self.kl_pd = symbol_pd.make_kl_df(benchmark, data_mode=EMarketDataSplitMode.E_DATA_SPLIT_SE,
                                          n_folds=n_folds,
                                          start=start, end=end)
...
"""
    ...
    @LazyFunc
    def kl_pd(self):
        kl_pd = symbol_pd.make_kl_df(self.benchmark, data_mode=EMarketDataSplitMode.E_DATA_SPLIT_SE,
