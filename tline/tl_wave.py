...
from core.pd_helper import pd_rolling_std, pd_ewm_mean, pd_ewm_std, pd_resample
...
def calc_wave_abs(kl_pd, xd=21, show=True):
    ...
    在默认xd＝21情况下，变成了月震荡幅度，使用stats_util.demean对
    ...
    """
        eg: change_ratio_sum
            ...
            2016-07-07    10.79
    """
    # 使用stats_util.demean进行去均值操作
    demean_wave = stats_util.demean(change_ratio_sum)
    """
        eg: demean_wave
        2014-07-24    -1.6303
        2014-08-14     0.5697
