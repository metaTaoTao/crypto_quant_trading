...
from indicators.indicator_base import plot_from_order, g_calc_type, ECalcType
from utils import scaler_util
from utils.dt_util import catch_error
from core.pd_helper import pd_ewm_mean
...
def plot_macd(prices, kl_index, with_points=None, with_points_ext=None,
    ...
    if with_price:
        plt.plot(kl_index, scaler_util.scaler_std(prices), label='close price')
...
if __name__ == '__main__':
    ...
    df = market_wrapper.create_k_data('BTC')
    plot_macd_from_klpd(df)